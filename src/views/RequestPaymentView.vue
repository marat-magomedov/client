...
async function fetchPaymentInfo() {
  try {
    loading.value = true;
    error.value = null;
    const response = await axios.get(`http://176.124.213.151/api/requests/pay/${paymentToken.value}/`);
...
async function handlePayment() {
  try {
    ...
    await axios.post(`http://176.124.213.151/api/requests/pay/${paymentToken.value}/`, {
